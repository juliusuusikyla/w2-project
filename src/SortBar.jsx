    ...
    <div className="sort-bar">
      <div className="sort-bar">
        <span className="sort-group">
          ❤︎ HP
          <span
            className={`sort-arrow ${sortBy === "hp" && sortDir === "asc" ? "active" : ""}`}
            onClick={() => {
              setSortBy("hp");
              setSortDir("asc");
            }}
          ...
          <span
            className={`sort-arrow ${sortBy === "hp" && sortDir === "desc" ? "active" : ""}`}
            onClick={() => {
              setSortBy("hp");
              setSortDir("desc");
            }}
        ...
        <span className="sort-group">
          ...
          Attack
          <span
            className={`sort-arrow ${sortBy === "attack" && sortDir === "asc" ? "active" : ""}`}
            onClick={() => {
              setSortBy("attack");
              setSortDir("asc");
            }}
          ...
          <span
            className={`sort-arrow ${sortBy === "attack" && sortDir === "desc" ? "active" : ""}`}
            onClick={() => {
              setSortBy("attack");
              setSortDir("desc");
            }}
          ...
          {sortBy && (
            <span className="sort-arrow active" onClick={() => setSortBy(null)}>
              ✕
            </span>
          )}
        </span>
